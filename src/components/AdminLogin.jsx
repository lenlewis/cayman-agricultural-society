...
export default function AdminLogin({ onLogin }) {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    // Simple auth — replace with real backend auth in production
    ...
    <>
      <button
        ...
        style={{
          ...
          padding: '10px 24px', borderRadius: 50, fontSize: '0.9rem',
          fontWeight: 600, cursor: 'pointer', transition: 'all 0.3s',
        }}
        onMouseEnter={e => e.target.style.background = '#1b5e3b'}
                ...
                <div style={{ marginBottom: 12 }}>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      background: '#f8faf5', transition: 'border-color 0.3s',
                    }}
